...
The SuperPlane CLI uses API tokens for authentication. For a full overview of authentication methods, see [Authentication and accounts](/concepts/authentication).
