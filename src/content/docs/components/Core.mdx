...
<CardGrid>
  <LinkCard title="Add Memory" href="#add-memory" description="Add a namespaced JSON value to app memory" />
  <LinkCard title="Approval" href="#approval" description="Collect approvals on events" />
  <LinkCard title="Delete Memory" href="#delete-memory" description="Delete values from app memory by namespace and field matches" />
  ...
  <LinkCard title="Read Memory" href="#read-memory" description="Find values from app memory by namespace and field matches" />
  ...
  <LinkCard title="Update Memory" href="#update-memory" description="Update values in app memory by namespace and field matches" />
...
The Add Memory component appends one or more items to app-level memory storage.
...
The Delete Memory component removes memory rows from app-level memory storage.
...
The Read Memory component looks up values from app-level memory storage.
...
The Update Memory component updates matching rows in app-level memory storage.
...
The Upsert Memory component updates matching rows in app-level memory storage, and creates a new row when no matches are found.
