...
This provisioning happens when you commit changes to the live version. Staged edits do not create the connector.
...
Provisioning happens when you commit changes to the live version. Staged edits do not create the connector or rule.
