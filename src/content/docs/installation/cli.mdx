...
```sh
curl -L https://install.superplane.com/v0.20.0/superplane-cli-darwin-arm64 -o superplane
chmod +x superplane
sudo mv superplane /usr/local/bin/superplane
```

Replace `darwin-arm64` with your platform (`darwin-amd64`, `linux-amd64`, `linux-arm64`).
