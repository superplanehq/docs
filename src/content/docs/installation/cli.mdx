...
- `true`: effective versioning enabled for this canvas. Use `superplane canvases update --draft -f ...` and then `publish`.
- `false`: effective versioning disabled for this canvas. Use `superplane canvases update -f ...` (no `--draft`), and do not use `publish`.
...
- If `superplane canvases publish ...` returns `effective canvas versioning is disabled for this canvas`,
  versioning is disabled for this canvas.
